...
### Simplifying interval variables using cut2()
...
### Simplifying interval variables with case_when
...
To fix this, we can make our new variale into an ordered factors and set the levels from youngest to oldest like this:
```{r}
